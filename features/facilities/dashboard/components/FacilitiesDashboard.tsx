...
import FacilitiesMap from "@/app/_components/FacilitiesMap";
...
export function FacilitiesDashboard({
  ...
  dashboard: FacilitiesDashboardViewModel;
}) {
  const {
    activityMarkers,
    activityRecords,
            ...
            >
              <div>
                ...
                <p className="mt-1 text-xs text-slate-500">
                  {activityRecords.length} registros distribuídos entre Atividade no Pátio e Chamado
                </p>
              </div>
